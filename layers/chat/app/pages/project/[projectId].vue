		...
		<div v-if="project" class="header">
			<div class="header-left">
				<div class="title-container">
					<h1 v-if="!isEditing" class="title" :class="{ 'cursor-pointer': !onChatPage }" @click="startEditing">
						{{ project.name }}
						<UIcon v-if="!onChatPage" name="i-heroicons-pencil" class="edit-icon" />
					</h1>
					<div v-else class="edit-container">
						...
						<div class="edit-actions">
							<UButton color="neutral" variant="soft" icon="i-heroicons-x-mark" size="xs" @click="cancelEditing" />
							<UButton color="primary" variant="soft" icon="i-heroicons-check" size="xs" @click="handleRename" />
						</div>
					</div>
				</div>
			...
			<UButton color="primary" icon="i-heroicons-plus" @click="handleNewChat"> New Chat in Project </UButton>
		</div>
